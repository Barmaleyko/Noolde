 ...
 * If doing a node build for server-side client, this getResponse is NOT included.
 * @api private
 */
...
var builder = module.exports = function () {
  ...
  files.forEach(function (file) {
    fs.readFile(file, function (err, content) {
      ...
      // pre-getResponse for non-server-side builds
      ...
      // post-getResponse for non-server-side builds
      if (!settings.node) {
          code += wrapperPost;
      }
